...
const GraphLegendOverlay = () => (
  <div className="absolute top-4 right-4 bg-white dark:bg-gray-900 rounded-lg shadow-lg p-4 flex flex-col space-y-2 text-sm z-10 border border-gray-200 dark:border-gray-700">
